...
* **Do not use conventional commit format**: PR titles must not use `type: summary` format.
* **Use human-readable titles**: Write PR titles as clear, descriptive phrases that explain the change for reviewers.
